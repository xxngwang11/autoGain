//
//  AutoGainExtensionDSPKernel.hpp
//  AutoGainExtension
//
...
#import "AutoGainExtensionParameterAddresses.h"

/*
 AutoGainExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class AutoGainExtensionDSPKernel {
public:
    ...
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case AutoGainExtensionParameterAddress::gain:
                mGain = value;
                break;
                // Add a case for each parameter in AutoGainExtensionParameterAddresses.h
        }
    }
    ...
    void process(std::span<float const*> inputBuffers, std::span<float *> outputBuffers, AUEventSampleTime bufferStartTime, AUAudioFrameCount frameCount) {
        /*
         ...
         modify the check in [AutoGainExtensionAudioUnit allocateRenderResourcesAndReturnError]
         */
